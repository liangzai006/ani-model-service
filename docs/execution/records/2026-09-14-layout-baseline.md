...
- 模块：`github.com/liangzai006/ani-model-service`
- 生成命令：`KRATOS_BIN=/tmp/model-tools/kratos BUF_BIN=/tmp/model-tools/buf scripts/new-service github.com/liangzai006/ani-model-service --parent /root/kubercon`
